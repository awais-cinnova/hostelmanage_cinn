...
const hostelOwners = [
  { id: "1", name: "Emily Johnson", email: "emily.johnson@cityhostels.com", phoneNumber: "+1 (415) 555-0198", hostelName: "Downtown City Hostel", age: 32, dob: "1992-06-14", gender: "Female", passportNumber: "X1234567", nationality: "American", maritalStatus: "Single"},
  { id: "2", name: "Michael Smith", email: "michael.smith@coasthostel.com", phoneNumber: "+1 (212) 555-2345", hostelName: "Coastline Backpackers", age: 40, dob: "1985-03-02", gender: "Male", passportNumber: "Y9876543", nationality: "American", maritalStatus: "Married"},
  { id: "3", name: "Samantha Lee", email: "samantha.lee@urbanstay.com", phoneNumber: "+1 (310) 555-8721", hostelName: "UrbanStay Hostel", age: 29, dob: "1996-08-22", gender: "Female", passportNumber: "Z5432198", nationality: "Canadian", maritalStatus: "Single"},
  { id: "4", name: "David Thompson", email: "david.thompson@midwesthostel.com", phoneNumber: "+1 (312) 555-1122", hostelName: "Midwest Traveler's Inn", age: 38, dob: "1987-11-05", gender: "Male", passportNumber: "A1928374", nationality: "American", maritalStatus: "Married"},
  { id: "5", name: "Natalie Rivera", email: "natalie.rivera@sunhostel.com", phoneNumber: "+1 (617) 555-6677", hostelName: "Sunny Bay Hostel", age: 35, dob: "1990-01-19", gender: "Female", passportNumber: "B7654321", nationality: "Mexican", maritalStatus: "Single"},
  { id: "6", name: "Chris Brown", email: "chris.brown@mountainlodge.com", phoneNumber: "+1 (206) 555-4422", hostelName: "Mountain Lodge Hostel", age: 42, dob: "1983-05-07", gender: "Male", passportNumber: "C3456789", nationality: "Canadian", maritalStatus: "Married"},
  { id: "7", name: "Charles Dan", email: "charles.dan@mountaintravelling.com", phoneNumber: "+1 (258) 165-4931", hostelName: "Mountain Travelling Hostel", age: 37, dob: "1988-09-11", gender: "Male", passportNumber: "D8765432", nationality: "British", maritalStatus: "Single"},
  { id: "8", name: "Harry Smith", email: "harry.smith@motel.com", phoneNumber: "+1 (243) 552-4322", hostelName: "Motel Hostel", age: 33, dob: "1992-12-03", gender: "Male", passportNumber: "E1122334", nationality: "Australian", maritalStatus: "Married"}
];
export const properties = [
  ...
  { id: "p4", ownerId: "1", hostelId: "3", name: "Los Apartment", location: "Down City", rooms: 3 }
];
    ...
    <div className="flex flex-col gap-6 flex-[250%]">
      ...
      <div className="w-full border border-[#00000033] p-4 rounded-2xl">
        ...
        <div className="flex  gap-3 mt-4">
          ...
          <a href={`https://wa.me/${owner.phoneNumber.replace(/\D/g, '')}`} target="_blank" className="px-3 py-2 bg-green-600 text-white rounded">💬 WhatsApp</a>
          <a href={`mailto:${owner.email}`} className="px-3 py-2 bg-blue-500 text-white rounded">✉️ Email</a>
        </div>
      </div>
    </div>

    {/* Right Column (Owned Properties) */}
    <div className="w-full border border-[#00000033] p-4  rounded-2xl">
